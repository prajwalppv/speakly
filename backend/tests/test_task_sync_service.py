...
class TestDeleteFromTicktick:
    ...
    async def test_delete_from_ticktick_success(self, mock_client_class, mock_session_local):
    ...
    @patch('app.services.task_sync_service.SessionLocal')
    @patch('app.services.ticktick.TickTickClient')
    async def test_delete_from_ticktick_handles_error(self, mock_client_class, mock_session_local):
...
class TestAsyncTaskSync:
    ...
    @patch('app.services.task_sync_service.task_sync_service')
    @patch('app.services.task_sync_service.SessionLocal')
    async def test_async_task_sync_handles_exception(self, mock_session_local, mock_service):
        ...
        mock_service.sync_all_pending_todos = AsyncMock(side_effect=Exception("Sync failed"))
