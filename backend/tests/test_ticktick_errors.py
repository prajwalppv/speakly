...
async def test_create_task_http_error(mock_settings, mock_client_class):
    ...
    import httpx
    from app.services.ticktick import TickTickAPIError, TickTickClient
...
async def test_delete_task_status_codes(mock_settings, mock_client_class):
    ...
    from app.services.ticktick import (
        TickTickAPIError,
        TickTickAuthError,
        TickTickClient,
    )
...
async def test_oauth_errors(mock_settings, mock_client_class):
    ...
    import httpx
    from app.services.ticktick import TickTickAuthError, TickTickOAuth
...
def test_oauth_missing_config(mock_settings):
    ...
    from app.services.ticktick import TickTickNotConfiguredError, TickTickOAuth
