...
class TestInitDatabase:
    ...
    def test_init_database_creates_tables(
        self, mock_base, mock_ensure_trans, mock_ensure_sess
    ):
    ...
    @patch("app.database._ensure_transcription_columns")
    @patch("app.database.Base")
    def test_init_database_ensures_columns(
        self, mock_base, mock_ensure_trans, mock_ensure_sess
    ):
...
class TestEnsureTranscriptionColumns:
    ...
    @patch("app.database.engine")
    @patch("app.database.inspect")
    def test_ensure_transcription_columns_missing_columns(
        self, mock_inspect, mock_engine
    ):
