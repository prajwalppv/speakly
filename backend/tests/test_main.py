...
class TestCreateApp:
    ...
    def test_create_app_returns_fastapi(
        self, mock_log, mock_init_db, mock_pj, mock_startup
    ):
    ...
    @patch("app.main.init_database")
    @patch("app.main.configure_logging")
    def test_create_app_registers_middleware(
        self, mock_log, mock_init_db, mock_pj, mock_startup
    ):
...
class TestExceptionHandlers:
    ...
    def test_exception_handler_developer_mode(
        self, mock_settings, mock_log, mock_init_db, mock_pj, mock_startup
    ):
